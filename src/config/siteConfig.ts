export const siteConfig = {
  ...
  payment: {
    ...
    methods: [
      { name: 'Наличными', description: 'Оплата наличными при получении товара' },
      { name: 'Kaspi перевод', description: 'Перевод на Kaspi Gold по номеру телефона' },
      { name: 'Kaspi QR', description: 'Оплата через Kaspi QR на месте' },
      { name: 'Безналичный расчёт', description: 'Для юридических лиц с НДС' },
    ],
  },
  ...
  about: {
    ...
    description: 'Оптовые поставки товаров в Караганде. Работаем с физическими и юридическими лицами.',
    content: [
      'Компания Paida All — надёжный оптовый поставщик товаров в Караганде.',
      'Мы работаем как с физическими, так и с юридическими лицами.',
      'Наш ассортимент включает более 2000 наименований товаров.',
      'Гарантируем качество продукции и оперативную доставку.',
    ],
    features: [
      { title: 'Широкий ассортимент', description: 'Более 2000 товаров в каталоге' },
      { title: 'Оптовые цены', description: 'Выгодные цены для всех клиентов' },
      { title: 'Быстрая доставка', description: 'Доставка за 1-2 рабочих дня' },
      { title: 'Надёжность', description: 'Работаем с 2020 года' },
    ],
  },
