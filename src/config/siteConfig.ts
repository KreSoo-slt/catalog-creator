export const siteConfig = {
  ...
  payment: {
    methods: [
      ...
      { name: 'Картой', icon: 'creditcard', description: 'Оплата банковской картой при получении через терминал.' },
      { name: 'Kaspi перевод', icon: 'smartphone', description: 'Перевод на Kaspi Gold перед доставкой или самовывозом.' },
      { name: 'Безналичный расчёт', icon: 'building', description: 'Для юридических лиц. Оплата по счёту с НДС или без НДС.' },
    ],
  },
  ...
  about: {
    ...
    features: [
      ...
      { title: 'Клиенты', description: 'Работаем с розничными магазинами, ИП и крупными торговыми сетями по всему Казахстану.' },
      { title: 'Доставка', description: 'Собственная логистика обеспечивает быструю и надёжную доставку товаров по Караганде и области.' },
      { title: 'Качество', description: 'Гарантируем подлинность и качество всей продукции. Работаем только с проверенными производителями.' },
    ],
    advantages: [
